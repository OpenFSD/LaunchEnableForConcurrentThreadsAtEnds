#ifdef LAUNCHENABLEFORCONCURRENTTHREADSATENDS_EXPORTS
#define LAUNCHENABLEFORCONCURRENTTHREADSATENDS_API __declspec(dllexport)
#else
#define LAUNCHENABLEFORCONCURRENTTHREADSATENDS_API __declspec(dllimport)
#endif

namespace Avril_FSD
{
	class LAUNCHENABLEFORCONCURRENTTHREADSATENDS_API ConcurrentQue_END {
	public:
		ConcurrentQue_END();
