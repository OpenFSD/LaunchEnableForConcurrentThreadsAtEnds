...
namespace ConcurrentQue
{
	...
	void ConcurrentQue_Client_Framework::Request_Wait_Launch(unsigned char concurrent_CoreId)
	{
		ConcurrentQue::ConcurrentQue_Client_Framework::Get_LaunchConcurrency()->Thread_Start(concurrent_CoreId);
	}
	void ConcurrentQue_Client_Framework::Thread_End(unsigned char concurrent_CoreId)
	{
	...
	unsigned char ConcurrentQue_Client_Framework::Get_coreId_To_Launch()
	{
